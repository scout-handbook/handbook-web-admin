...
function restoreLessonShowVersion(id: string, event: Event): void
{
	...
	request(CONFIG["api-uri"] + "/v0.9/deleted-lesson/" + id + "/history/" + version, "GET", {}, function(response: RequestResponse): void
	{
...
function restoreLessonSelectVersion(): void
{
	...
	if(lessonId)
	{
		...
		request(CONFIG["api-uri"] + "/v0.9/deleted-lesson/" + lessonId + "/history", "GET", {}, function(response: RequestResponse): void
		{
...
function restoreLesson(): void
{
	...
	request(CONFIG["api-uri"] + "/v0.9/deleted-lesson", "GET", {}, function(response: RequestResponse): void
	{
