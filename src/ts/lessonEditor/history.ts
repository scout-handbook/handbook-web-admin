...
function lessonHistoryListRender(
  ...
  html +=
    '<div class="formRow"><label class="formSwitch"><input type="radio" name="version" checked><span class="form-custom form-radio"></span></label><span class="lessonHistoryCurrent">Současná verze</span> — ' +
