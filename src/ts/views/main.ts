...
function showMainView(noHistory: boolean): void
{
	...
	html += "<div id=\"logLink\"><a href=\"" + CONFIG["api-uri"] + "/v0.9/logout?redirect-uri=" + encodeURIComponent(CONFIG['frontend-uri']) + "\">Odhlásit</a><a href=\"/\" id=\"frontendLink\">Zpět na web</a></div></div>";
